...
def addFlash(i, j, grid):
    flash = np.array([[0, 255, 0],
                      [0, 255, 0],
                      [0, 255, 0]])
    grid[i:i + 3, j:j + 3] = flash


def addBread(i, j, grid):
...
def main():
    ...
    parser.add_argument('--flash', action='store_true', required=False)
    parser.add_argument('--bread', action='store_true', required=False)
